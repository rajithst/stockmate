...
Revision ID: 11b5a57e7a5b
Revises:
Create Date: 2025-10-19 22:31:55.195518
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "accumulated_other_comprehensive_income_loss", sa.Integer(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_company_balance_sheets_company_id"),
        "company_balance_sheets",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_balance_sheets_symbol"),
        "company_balance_sheets",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "net_cash_provided_by_operating_activities", sa.Integer(), nullable=False
        ),
        sa.Column(
            "investments_in_property_plant_and_equipment", sa.Integer(), nullable=False
        ),
        ...
        sa.Column(
            "net_cash_provided_by_investing_activities", sa.Integer(), nullable=False
        ),
        ...
        sa.Column(
            "net_cash_provided_by_financing_activities", sa.Integer(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_company_cash_flow_statements_company_id"),
        "company_cash_flow_statements",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_cash_flow_statements_symbol"),
        "company_cash_flow_statements",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_company_dcf_company_id"), "company_dcf", ["company_id"], unique=False
    )
    op.create_index(op.f("ix_company_dcf_id"), "company_dcf", ["id"], unique=False)
    op.create_index(
        op.f("ix_company_dcf_symbol"), "company_dcf", ["symbol"], unique=False
    )
    op.create_table(
        "company_dividends",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_dividends_company_id"),
        "company_dividends",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_dividends_id"), "company_dividends", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_company_dividends_symbol"),
        "company_dividends",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "free_cash_flow_operating_cash_flow_ratio", sa.Float(), nullable=True
        ),
        sa.Column("debt_service_coverage_ratio", sa.Float(), nullable=True),
        sa.Column("interest_coverage_ratio", sa.Float(), nullable=True),
        sa.Column(
            "short_term_operating_cash_flow_coverage_ratio", sa.Float(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_company_financial_ratios_company_id"),
        "company_financial_ratios",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_financial_ratios_id"),
        "company_financial_ratios",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_financial_ratios_symbol"),
        "company_financial_ratios",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_financial_scores",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("company_id", sa.Integer(), nullable=False),
        sa.Column("symbol", sa.String(length=12), nullable=False),
        sa.Column("reported_currency", sa.String(length=10), nullable=True),
    ...
    op.create_index(
        op.f("ix_company_financial_scores_company_id"),
        "company_financial_scores",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_financial_scores_id"),
        "company_financial_scores",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_financial_scores_symbol"),
        "company_financial_scores",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_general_news",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_general_news_company_id"),
        "company_general_news",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_general_news_id"), "company_general_news", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_company_general_news_symbol"),
        "company_general_news",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_grading_news",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("company_id", sa.Integer(), nullable=False),
        sa.Column("symbol", sa.String(length=12), nullable=False),
        sa.Column("published_date", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_grading_news_company_id"),
        "company_grading_news",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_grading_news_id"), "company_grading_news", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_company_grading_news_symbol"),
        "company_grading_news",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_grading_summaries",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("company_id", sa.Integer(), nullable=False),
        sa.Column("symbol", sa.String(length=12), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_grading_summaries_id"),
        "company_grading_summaries",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_grading_summaries_symbol"),
        "company_grading_summaries",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_company_gradings_company_id"),
        "company_gradings",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_gradings_id"), "company_gradings", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_company_gradings_symbol"), "company_gradings", ["symbol"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "selling_general_and_administrative_expenses", sa.Integer(), nullable=False
        ),
        ...
        sa.Column(
            "non_operating_income_excluding_interest", sa.Integer(), nullable=False
        ),
        ...
        sa.Column(
            "net_income_from_continuing_operations", sa.Integer(), nullable=False
        ),
        sa.Column(
            "net_income_from_discontinued_operations", sa.Integer(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_company_income_statements_company_id"),
        "company_income_statements",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_income_statements_id"),
        "company_income_statements",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_income_statements_symbol"),
        "company_income_statements",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "sales_general_and_administrative_to_revenue", sa.Float(), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_company_key_metrics_company_id"),
        "company_key_metrics",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_key_metrics_id"), "company_key_metrics", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_company_key_metrics_symbol"),
        "company_key_metrics",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_company_price_target_news_id"),
        "company_price_target_news",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_price_target_news_symbol"),
        "company_price_target_news",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_price_target_summaries",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("company_id", sa.Integer(), nullable=False),
        sa.Column("symbol", sa.String(length=12), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_price_target_summaries_id"),
        "company_price_target_summaries",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_price_target_summaries_symbol"),
        "company_price_target_summaries",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_price_targets",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("company_id", sa.Integer(), nullable=False),
        sa.Column("symbol", sa.String(length=12), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_price_targets_company_id"),
        "company_price_targets",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_price_targets_id"),
        "company_price_targets",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_price_targets_symbol"),
        "company_price_targets",
        ["symbol"],
        unique=False,
    )
    op.create_table(
        "company_rating_summaries",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("company_id", sa.Integer(), nullable=False),
        sa.Column("symbol", sa.String(length=12), nullable=False),
    ...
    op.create_index(
        op.f("ix_company_rating_summaries_company_id"),
        "company_rating_summaries",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_rating_summaries_id"),
        "company_rating_summaries",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_rating_summaries_symbol"),
        "company_rating_summaries",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_company_stock_peers_company_id"),
        "company_stock_peers",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_stock_peers_symbol"),
        "company_stock_peers",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_company_stock_splits_company_id"),
        "company_stock_splits",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_stock_splits_symbol"),
        "company_stock_splits",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_stock_price_changes_company_id"),
        "stock_price_changes",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_stock_price_changes_symbol"),
        "stock_price_changes",
        ["symbol"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_stock_prices_company_id"), "stock_prices", ["company_id"], unique=False
    )
    op.create_index(
        op.f("ix_stock_prices_symbol"), "stock_prices", ["symbol"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_stock_price_changes_symbol"), table_name="stock_price_changes"
    )
    op.drop_index(
        op.f("ix_stock_price_changes_company_id"), table_name="stock_price_changes"
    )
    op.drop_table("stock_price_changes")
    op.drop_index(
        op.f("ix_company_stock_splits_symbol"), table_name="company_stock_splits"
    )
    op.drop_index(
        op.f("ix_company_stock_splits_company_id"), table_name="company_stock_splits"
    )
    op.drop_table("company_stock_splits")
    op.drop_index(
        op.f("ix_company_stock_peers_symbol"), table_name="company_stock_peers"
    )
    op.drop_index(
        op.f("ix_company_stock_peers_company_id"), table_name="company_stock_peers"
    )
    op.drop_table("company_stock_peers")
    op.drop_index(
        op.f("ix_company_rating_summaries_symbol"),
        table_name="company_rating_summaries",
    )
    op.drop_index(
        op.f("ix_company_rating_summaries_id"), table_name="company_rating_summaries"
    )
    op.drop_index(
        op.f("ix_company_rating_summaries_company_id"),
        table_name="company_rating_summaries",
    ...
    op.drop_index(
        op.f("ix_company_price_targets_symbol"), table_name="company_price_targets"
    )
    op.drop_index(
        op.f("ix_company_price_targets_id"), table_name="company_price_targets"
    )
    op.drop_index(
        op.f("ix_company_price_targets_company_id"), table_name="company_price_targets"
    )
    op.drop_table("company_price_targets")
    op.drop_index(
        op.f("ix_company_price_target_summaries_symbol"),
        table_name="company_price_target_summaries",
    )
    op.drop_index(
        op.f("ix_company_price_target_summaries_id"),
        table_name="company_price_target_summaries",
    ...
    op.drop_index(
        op.f("ix_company_price_target_news_symbol"),
        table_name="company_price_target_news",
    )
    op.drop_index(
        op.f("ix_company_price_target_news_id"), table_name="company_price_target_news"
    )
    op.drop_table("company_price_target_news")
    op.drop_index(
        op.f("ix_company_key_metrics_symbol"), table_name="company_key_metrics"
    )
    op.drop_index(op.f("ix_company_key_metrics_id"), table_name="company_key_metrics")
    op.drop_index(
        op.f("ix_company_key_metrics_company_id"), table_name="company_key_metrics"
    )
    op.drop_table("company_key_metrics")
    op.drop_index(
        op.f("ix_company_income_statements_symbol"),
        table_name="company_income_statements",
    )
    op.drop_index(
        op.f("ix_company_income_statements_id"), table_name="company_income_statements"
    )
    op.drop_index(
        op.f("ix_company_income_statements_company_id"),
        table_name="company_income_statements",
    ...
    op.drop_index(
        op.f("ix_company_grading_summaries_symbol"),
        table_name="company_grading_summaries",
    )
    op.drop_index(
        op.f("ix_company_grading_summaries_id"), table_name="company_grading_summaries"
    )
    op.drop_table("company_grading_summaries")
    op.drop_index(
        op.f("ix_company_grading_news_symbol"), table_name="company_grading_news"
    )
    op.drop_index(op.f("ix_company_grading_news_id"), table_name="company_grading_news")
    op.drop_index(
        op.f("ix_company_grading_news_company_id"), table_name="company_grading_news"
    )
    op.drop_table("company_grading_news")
    op.drop_index(
        op.f("ix_company_general_news_symbol"), table_name="company_general_news"
    )
    op.drop_index(op.f("ix_company_general_news_id"), table_name="company_general_news")
    op.drop_index(
        op.f("ix_company_general_news_company_id"), table_name="company_general_news"
    )
    op.drop_table("company_general_news")
    op.drop_index(
        op.f("ix_company_financial_scores_symbol"),
        table_name="company_financial_scores",
    )
    op.drop_index(
        op.f("ix_company_financial_scores_id"), table_name="company_financial_scores"
    )
    op.drop_index(
        op.f("ix_company_financial_scores_company_id"),
        table_name="company_financial_scores",
    ...
    op.drop_index(
        op.f("ix_company_financial_ratios_symbol"),
        table_name="company_financial_ratios",
    )
    op.drop_index(
        op.f("ix_company_financial_ratios_id"), table_name="company_financial_ratios"
    )
    op.drop_index(
        op.f("ix_company_financial_ratios_company_id"),
        table_name="company_financial_ratios",
    ...
    op.drop_index(
        op.f("ix_company_dividends_company_id"), table_name="company_dividends"
    )
    ...
    op.drop_index(
        op.f("ix_company_cash_flow_statements_symbol"),
        table_name="company_cash_flow_statements",
    )
    op.drop_index(
        op.f("ix_company_cash_flow_statements_company_id"),
        table_name="company_cash_flow_statements",
    ...
    op.drop_index(
        op.f("ix_company_balance_sheets_symbol"), table_name="company_balance_sheets"
    )
    op.drop_index(
        op.f("ix_company_balance_sheets_company_id"),
        table_name="company_balance_sheets",
    )
