...
Revision ID: 8bcae02d1b33
Revises:
Create Date: 2025-10-16 00:49:41.560654
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_company_ratings_company_id"),
        "company_ratings",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_ratings_id"), "company_ratings", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_company_ratings_symbol"), "company_ratings", ["symbol"], unique=False
    )
    op.create_table(
        "company_stock_peers",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
