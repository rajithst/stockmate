...
class FMPStockScreenResult(BaseModel):
    ...
    last_annual_dividend: float = Field(..., alias="lastAnnualDividend", description="Most recent annual dividend")
    volume: int = Field(..., description="Latest trading volume")
    exchange: str = Field(..., description="Full name of the exchange")
    exchange_short_name: str = Field(..., alias="exchangeShortName", description="Short exchange name")
    ...
    is_actively_trading: bool = Field(..., alias="isActivelyTrading",
                                      description="True if stock is actively trading")
...
class FMPStockRating(BaseModel):
    ...
    discounted_cash_flow_score: Optional[int] = Field(None, alias="discountedCashFlowScore")
...
class FMPStockPriceTarget(BaseModel):
    ...
    last_quarter_avg_price_target: Optional[float] = Field(None, alias="lastQuarterAvgPriceTarget")
    last_year_count: Optional[int] = Field(None, alias="lastYearCount")
    last_year_avg_price_target: Optional[float] = Field(None, alias="lastYearAvgPriceTarget")
    all_time_count: Optional[int] = Field(None, alias="allTimeCount")
    all_time_avg_price_target: Optional[float] = Field(None, alias="allTimeAvgPriceTarget")
